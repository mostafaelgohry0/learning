...
var users = {
  ...
  "user1" : {
    ...
    "user18" : {
      "personalDate" : {
        "adress" : "mansora",
        "birthDate" : "1962-04-09",
        "email" : "selian@mail.com",
        "name" : "selian",
        "sex" : "female"
      }
    },
...
console.log(users[i].personalData.name);
console.log(users[i].personalData.name);
console.log(users[i].personalData.name);
//console.log(users.user1.personalData.email);
